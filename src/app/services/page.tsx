...
const CATEGORIES = [
  ...
  { label: "Web Solutions", active: false },
  { label: "ERP & Cloud Systems", active: false },
  { label: "BPO & Outsourcing", active: false },
...
const SERVICE_CARDS: ServiceCard[] = [
    ...
    footerLeft: (
      <div className="flex items-center gap-3">
        <div className="flex -space-x-2">
          <div className="w-8 h-8 rounded-full border-2 border-white bg-surface-dim overflow-hidden">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              className="w-full h-full object-cover"
              alt="Senior software engineer"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuByMwkXDuvOUoOoTgqNJsSeqtMLlTDRcw9FhmL-J6_iy0S63FivWev4Z77Iozmv3y7P_BGwL_3LvBbt3GQQCNn0DiIjbuJFmSelqP60iMnWMAm43wDexz0joVoOVOxu3e13ONgaKTZvPk8-3R1mQGO1X83ZBDr64bqa75Yj3eJyYMmlWSKm0KV11qHF1vN2GB3iqNNuIewqu1jFT9DrQe_xX78B8y0E0wQZ19daag3kf85aw5CFRhoF6bjKt69_nrgnxJx0QDprVuHT"
            />
          </div>
          <div className="w-8 h-8 rounded-full border-2 border-white bg-surface-dim overflow-hidden">
            {/* eslint-disable-next-line @next/next/no-img-element */}
            <img
              className="w-full h-full object-cover"
              alt="Tech product manager"
              src="https://lh3.googleusercontent.com/aida-public/AB6AXuDcVNQHFcPzRao2hQg-ohhklZOVa-qTODXJ-HK6pOSeucnzk-WhbleqTbVbgXH4-fuGJNXb8kbdbC8ZYtm6alT_bRJ0XKVQolu7bXusR1WK1VB1aU0p02Q9gJjJ4ESmBoWekbJD2XJz0UYBg_9x2K_8___5yJ0Ktop3QYymRdbdS0ccN5BBbzAyEnQUdAAj3mTViHUwF0LANZS8jvULu88WiFmnnuKJ_kNWgF1VIJ5ObeNBDb7UxX7D7io1DP5_BPTQdt0AF8GLBBz8"
            />
          </div>
        </div>
        <span className="text-on-surface-variant font-label-sm text-label-sm">
          Managed by expert architects
        </span>
      </div>
    ),
  },
  ...
  },
  {
    ...
    footerLeft: (
      <p className="text-on-surface-variant font-label-sm text-label-sm">
        Full lifecycle support available
      </p>
    ),
  },
  {
  ...
  },
  {
    ...
    footerLeft: (
      <p className="text-on-surface-variant font-label-sm text-label-sm">
        Proven ROI-driven implementations
      </p>
    ),
  },
];
      ...
      <header className="pt-8 pb-8 md:pt-[52px] md:pb-stack-lg bg-surface-container-lowest">
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <p className="font-body-lg text-body-lg text-secondary max-w-2xl">
            We empower organizations with cutting-edge technology services designed
            for scalability, security, and peak performance.
          </p>
        </div>
      </header>
      ...
      <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop py-8 md:py-stack-lg">
        <div className="flex flex-col md:flex-row gap-gutter">
          ...
          <aside className="w-full md:w-1/4 shrink-0">
            ...
            {/* On desktop: vertical sticky panel */}
            <div className="hidden md:block sticky top-[100px] bg-surface-container-lowest border border-outline-variant p-6 rounded-xl">
                    ...
                    >
                      ...
                      <span
                        className={[
                          ...
                          cat.active ? "opacity-100" : "opacity-0 group-hover:opacity-100",
                        ].join(" ")}
                      >
                        chevron_right
                      </span>
              ...
              <div className="mt-10 p-4 bg-primary-container rounded-lg text-surface-container-lowest">
                <p className="font-label-sm text-label-sm mb-2 opacity-80">
                  Need help choosing?
                </p>
          ...
          <section className="w-full md:w-3/4 space-y-6 md:space-y-8">
            {SERVICE_CARDS.map((service) => (
              ...
              >
                {/* Card header row: icon + optional badge */}
                <div className="flex items-start justify-between mb-6">
                  ...
                  {service.badge && (
                    <span
                      className={`px-3 py-1 rounded-full font-label-sm text-label-sm ${service.badge.className}`}
                    >
                      {service.badge.text}
                    </span>
                  )}
                ...
                {/* Title */}
                <h3 className="font-h3 text-h3 text-primary mb-3 md:mb-4">
                  {service.title}
                </h3>
                ...
                <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pt-6 border-t border-outline-variant">
                  <div className="shrink-0">{service.footerLeft}</div>
                  <Link href="/contact">
