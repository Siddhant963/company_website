...
const FILTER_TABS = ['All', 'App Dev', 'Web Dev', 'UI/UX Design', 'Cloud Solutions', 'SaaS Platform'];

// Featured project — SaaS Platform + App Dev
const FEATURED = {
  categories: ['All', 'SaaS Platform', 'App Dev'],
  image:
    'https://lh3.googleusercontent.com/aida-public/AB6AXuAGpensZeeVZkrA4mDNX6SOaHnpZAlRDCYhLBi1gVuRfItV2zVm_AwDn1OrYYxGA5sTlN03ATUG_CHJctcwrtQrXO_bCCS11Eh82KsgDmUdTu6lSyQG0p4gi8hNOFwS18IMcL3OfyBv5YJ494cATtMFiFfvJDxPnmRirFRLvd5F7ueEaI8Wx9s_C2lzWRWg4f5_iXn1wElcsOJn5MTPqRKiqbMLP8GFFiwjetc5pznO7V3w9S4dLI3eEQKX53u32vMqiXT9DZmB0cqL',
  imageAlt:
    'SellWhatUMade e-commerce dashboard displayed on mobile and desktop in a vibrant corporate light-mode theme',
  tags: ['React Native', 'Node.js', 'AWS Cloud', 'GraphQL'],
};

const PORTFOLIO_PROJECTS = [
  {
    id: 1,
    categories: ['All', 'Web Dev', 'UI/UX Design'],
    badge: 'FINTECH',
    ...
    imageAlt: 'WealthFlow FinTech dashboard with financial charts',
    tags: ['Vue.js', 'Python'],
  },
  {
    id: 2,
    categories: ['All', 'App Dev'],
    badge: 'LOGISTICS',
    ...
    imageAlt: 'FleetMaster Pro logistics app on smartphone mockup',
    tags: ['Flutter', 'Go'],
  },
  {
    id: 3,
    ...
    imageAlt: 'MedConnect Portal on a tablet showing patient scheduling',
    tags: ['Next.js', 'HIPAA API'],
  },
  {
    id: 4,
    categories: ['All', 'Cloud Solutions'],
    badge: 'INDUSTRY 4.0',
    badgeCls: 'text-on-primary-container bg-primary-container/10',
    ...
    imageAlt: 'SmartFactory AI industrial IoT management platform',
  ...
  },
  {
    ...
    imageAlt: 'AgriTrack mobile app showing a logistics dashboard for farmers',
    tags: ['Flutter', 'Firebase'],
  },
  {
    id: 6,
    categories: ['All', 'SaaS Platform', 'Web Dev'],
    badge: 'EDTECH',
    badgeCls: 'text-on-primary-container bg-primary-container/10',
    title: 'EduPortal LMS',
    description:
    ...
    imageAlt: 'EduPortal LMS showing a corporate e-learning catalog',
...
export default function OurWorkClient() {
  ...
  const showFeatured = FEATURED.categories.includes(activeTab);
  const filteredProjects = PORTFOLIO_PROJECTS.filter((p) => p.categories.includes(activeTab));
      ...
      <section className="bg-primary-container py-16 text-center">
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          ...
          <p className="text-surface-container-lowest/70 font-body-lg text-body-lg max-w-2xl mx-auto">
            We combine precision engineering with creative design to build digital solutions that
            drive global enterprise growth.
          </p>
        </div>
      </section>
            ...
            <div className="bg-surface-container-lowest rounded-xl border border-outline-variant overflow-hidden flex flex-col md:flex-row shadow-sm hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                ...
                <p className="font-body-lg text-body-lg text-on-surface-variant mb-8 leading-relaxed">
                  A comprehensive multi-tenant marketplace platform designed for creators. We
                  engineered a scalable backend infrastructure coupled with a fluid React Native
                  mobile experience to handle high-volume transactions seamlessly.
                </p>
        ...
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop">
          {filteredProjects.length === 0 && !showFeatured ? (
            <div className="text-center py-20 text-on-surface-variant">
              ...
              <p className="font-body-lg text-body-lg">No projects in this category yet.</p>
            </div>
          ) : (
              ...
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="p-6 flex flex-col flex-grow">
                    <div className="mb-3">
                      <span className={`text-xs font-bold px-2 py-0.5 rounded ${project.badgeCls}`}>
                        {project.badge}
                      </span>
                    </div>

                    <h3 className="font-h3 text-h3 text-primary mb-3">{project.title}</h3>
                    ...
                    <div className="mt-auto">
                      ...
                      >
                        View Case Study
                        <span className="material-symbols-outlined text-[18px] ml-1">open_in_new</span>
                      </Link>
                    </div>
                  </div>
                </article>
      ...
      <section className="py-24 bg-surface-container-low">
        <div className="max-w-max-width mx-auto px-margin-mobile md:px-margin-desktop text-center">
          ...
          <p className="text-on-surface-variant font-body-lg text-body-lg max-w-2xl mx-auto mb-10">
            Let&apos;s build something exceptional together. Our team is ready to transform your
