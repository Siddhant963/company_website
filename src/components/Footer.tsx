    ...
    <footer className="w-full pt-stack-lg pb-stack-md bg-primary-container">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-gutter px-margin-desktop max-w-max-width mx-auto">
        <div className="space-y-4">
          ...
          <a
            href="https://www.linkedin.com/company/siddhya-technology-pvt-ltd/"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="Siddhya Technology on LinkedIn"
            className="inline-flex items-center justify-center w-10 h-10 rounded-lg bg-surface-container-lowest/10 text-surface-container-lowest hover:bg-[#0A66C2] hover:text-white transition-colors"
          >
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
